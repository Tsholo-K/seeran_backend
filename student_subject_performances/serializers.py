...
class StudentPerformanceSerializer(serializers.ModelSerializer):
    ...
    def get_assessments(self, obj):
        return GradedAssessmentsSerializer(obj.subject.assessments.filter(term=obj.term, grade=obj.grade, grades_released=True), many=True).data if obj.subject else None
