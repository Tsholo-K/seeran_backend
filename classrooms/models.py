...
class Classroom(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['group', 'grade', 'subject', 'school'], name='unique_group_grade_subject_classroom'),
            models.UniqueConstraint(fields=['group', 'grade', 'register_classroom', 'school'], name='unique_group_grade_register_classroom')
        ]
