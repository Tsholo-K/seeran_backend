...
class SubmissionModelTest(TestCase):
    ...
    def test_late_submission(self):
        ...
        submission = Submission.objects.create(student=self.student_a, assessment=self.assessment)
    ...
    def test_unique_constraint(self):
        ...
        Submission.objects.create(student=self.student_a, assessment=self.assessment, status='ONTIME')

        # Try to create a second submission, which should raise a ValidationError due to the unique constraint
        with self.assertRaises(ValidationError):
            Submission.objects.create(student=self.student_a, assessment=self.assessment, status='LATE')
    ...
    def test_excused_submission(self):
        ...
        """
        submission = Submission.objects.create(student=self.student_a, assessment=self.assessment, status='EXCUSED')
