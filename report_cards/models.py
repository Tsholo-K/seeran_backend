...
class ReportCard(models.Model):
    ...
    #             for term in terms:
    #                 try:
    #                     subject_score = SubjectScore.objects.get(student=self.student, term=term, subject=subject)
    ...
    #     """
    #     absences = Attendance.objects.filter(absent_students=self.student, date__date__range=(self.term.start_date.date(), self.term.end_date.date())).values('date').distinct()
    ...
    #     late_arrivals = Attendance.objects.filter(late_students=self.student, date__date__range=(self.term.start_date.date(), self.term.end_date.date())).values('date').distinct()
