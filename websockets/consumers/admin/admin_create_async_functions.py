        ...
        if serializer.is_valid():
            with transaction.atomic():
                ...
                if details['role'] == 'TEACHER' and details.get('grant_full_access'):
                    ...
                    if created:
                        permissions = []
                        for action, targets in {"create": ["ACTIVITY","ASSESSMENT"], "update": ["ASSESSMENT"], "view": ["ACCOUNT", "PROGRESS_REPORT", "CLASSROOM", "ATTENDANCE", "ACTIVITY", "ASSESSMENT", "TRANSCRIPT", "TIMETABLE", "TEACHER_TIMETABLE", "GROUP_TIMETABLE"], "delete": ["ASSESSMENT"], "submit": ["ATTENDANCE"], "generate": ["PROGRESS_REPORT"]}.items():
