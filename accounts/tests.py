...
# models
from .models import BaseAccount, Founder, Principal, Admin, Teacher, Parent, Student
...
class BaseUserTests(TestCase):
    ...
    def test_invalid_role(self):
        ...
        test_user = BaseAccount(**test_user_data)
        ...
        self.assertIn(
            'Could not process your request, the specified account role is invalid. Please choose a valid role from the options: %s.' % [dict(BaseAccount.ROLE_CHOICES).keys()],
            error_message
        )

    def test_unique_email_address(self):
        BaseAccount.objects.create(**self.base_user_data)

        test_user_b = BaseAccount(
            name='Jane',
            surname='Doe',
    ...
    def test_invalid_name(self):
        ...
        test_user_a = BaseAccount(**test_user_data) # user a
        ...
        test_user_data['name'] = ''
        test_user_b = BaseAccount(**test_user_data) # user b
